...
public class MatrixMultiply {
   ...
   *
   * <p>
   * <code>multiply.MatrixMultiply  inputPathM inputPathN outputPath</code>
   *
   * <p>
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 3) {
      System.err
          .println("Usage: multiply.MatrixMultiply <inputPathM> <inputPathN> <outputPath>");
      System.exit(2);
    } else {
    ...
    Job job = new Job(conf, "multiply.MatrixMultiply");
